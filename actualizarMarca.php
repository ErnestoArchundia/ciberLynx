...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php
          ...
          #Consulta 
          $sql = "CALL proc_marca($marca);";
          $ejecConsulta = mysqli_query($conexion, $sql);
          if(mysqli_num_rows($ejecConsulta) > 0) {
            $conMarca = mysqli_fetch_array($ejecConsulta);
            ?> 
      <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-6 mt-3">
        <form id="formRegistro" class="formulario" action="actualizarMarcabd.php" method="POST">
        <input type="hidden" name="txtIdMarca" value="<?php echo $conMarca['Id_Marca']; ?>">
        <div class="form-group">
            <label for="nombre">Nombre Marca:</label>
            <input type="text" class="form-control" name="txtNombreMarca" value="<?php echo $conMarca['Nombre_Marca']; ?>" required>
        </div>
