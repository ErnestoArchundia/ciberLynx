  ...
  <class="content-wrapper">
    <div>
      ...
      <div class="row justify-content-center">
        ...
        <form id="formRegistro" class="formulario" action="agregarUsuariobd.php" method="POST">
    	      
        <div class="form-group">
        <label for="marca">Rol:</label>
              ...
              <option selected>Seleccionar Rol</option>
                <?php
                  ...
                  while ($regMarca = mysqli_fetch_assoc($marca)) {
                    echo "<option value='" . $regMarca['Id_Rol'] . "'>" . $regMarca['Nombre_Rol'] . "</option>";
                  }
        ...
        <div class="form-group">
          <label for="nombre">Apellid Paterno:</label>
          <input type="text" class="form-control" placeholder="Apellido Paterno:" name="txtP" required>
        </div>

        <div class="form-group">
          <label for="nombre">Apellid Materno:</label>
          <input type="text" class="form-control" placeholder="Apellido Materno:" name="txtM" required>
        </div>

        <div class="form-group">
          <label for="nombre">Usuario Nombre:</label>
          <input type="text" class="form-control" placeholder="Usuario Nombre:" name="txtUsuario" required>
        </div>

        <div class="form-group">
          <label for="nombre">Contraseña:</label>
          <input type="text" class="form-control" placeholder="Contrasenia:" name="txtContrasenia" required>
        </div>
