    ...
    <?php
      ...
      <div class="row justify-content-center">
        ...
        <form id="formRegistro" class="formulario" action="actualizarClientebd.php" method="POST">
            ...
            <input type="text"  class="form-control" placeholder="Nombre:" name="txtNombre" value="<?php echo $conPersona['Nombre']; ?>" required>
            </div>
            <div class="form-group">
            <label for="apellidop">Apellido Paterno:</label>
            <input type="text" class="form-control" placeholder="Apellido Paterno:" name="txtApellidoP" value="<?php echo $conPersona['Apellido_Paterno']; ?>" required>
            </div>
            <div class="form-group">
            <label for="apellidom">Apellido Materno:</label>
            <input type="text" class="form-control" placeholder="Apellido Materno:" name="txtApellidoM" value="<?php echo $conPersona['Apellido_Materno']; ?>" required>
            </div>
